...
public class PlagiarismDetectorTest {
	...
	/*
	 * Run this test to check the correctness of the program as a whole.
	 * This test is assumed to be sound, such that it should pass once all bugs have been removed.
	 */
	@Test
	public void testMain() {
    	...
    	// run the method
        try {
    	    map = new PlagiarismDetector().detectPlagiarism(directory, 4, 5);
        }
